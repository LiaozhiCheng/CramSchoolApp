...
function uploadData(grade_no) {
    ...
    $.ajax({
        url: "https://3aac3445b286.ngrok.io/teacher/edit_course_grade",   //後端的URL
        type: "POST",   //用POST的方式
...
function deleteGrade(grade_no) {
    $.ajax({
        url: "https://3aac3445b286.ngrok.io/teacher/delete_course_grade?lesson_id=" + globalData[grade_no].lesson_id, //放你的url，這裡先放本地端檔案

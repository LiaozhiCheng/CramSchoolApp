...
function createTable(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        content += "<tr><td><a href='' onclick='Click(" + i + ")'>" + data[i].student_name + "</a></td>"
...
function start() {
    ...
    $.ajax({
        url: "https://38049d8c9137.ngrok.io//teacher_course_student_list?course_id=C-" + course_id, //放你的url，這裡先放本地端檔案
